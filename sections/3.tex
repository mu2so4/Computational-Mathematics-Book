...
формулы, то есть мы их применяли сразу ко всему отрезку интегрирования. Теперь
мы применим эти же формулы не на всём отрезке разом, а на его составных частях.
...
\begin{define}
	...
	простую квадратурную формулу на каждом из $N$ равных по длине 
