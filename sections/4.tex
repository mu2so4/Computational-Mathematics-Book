...
\begin{corollary}
	...
	\begin{enumerate}[nosep]
		\item $|M|<n+k$, то при таком шаблоне не существует
			требуемых разностных операторов.
		\item $|M|=n+k$, то при таком шаблоне существует
			единственный требуемый разностный оператор.
		\item $|M|>n+k$, то при таком шаблоне существует
			бесконечно много требуемых разностных операторов.
	\end{enumerate}
\end{corollary}
